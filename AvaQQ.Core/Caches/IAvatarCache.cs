...
public interface IAvatarCache
{
	...
	/// </param>
	/// <param name="forceUpdate">强制触发更新，请订阅 <see cref="EventStation.UserAvatar"/> 接收更新事件</param>
	/// <returns>此方法返回的是缓存的头像，若头像不存在或者过期，会触发更新，请订阅 <see cref="EventStation.UserAvatar"/> 接收更新事件</returns>
